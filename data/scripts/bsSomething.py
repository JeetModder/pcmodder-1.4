...
class BlastBot(bs.Actor):
    ...
    def __init__(self, position=(0,1,0)):#beast bot made by PC
        ...
        self.timer = bs.gameTimer(1500,bs.Call(_blast),repeat=True)
...
class Bomber(bs.Actor):
    ...
    def __init__(self, position=(0,1,0)):#another beast bot made by PC
        ...
        def _blast():  
            ...
            bs.Bomb(position=self.node.position,velocity=((0+random.random()*-20.0),(0+random.random()*-20.0),(0+random.random()*-20.0)),bombType = k).autoRetain()
            bs.Bomb(position=self.node.position,velocity=((0+random.random()*20.0),(0+random.random()*20.0),(0+random.random()*20.0)),bombType = k).autoRetain()
        bs.gameTimer(3000,bs.Call(_blast),repeat=True)
    ...
    def __init__(self, position=(0,1,0)):#another beast bot made by PC
        ...
        def _bot():
                ...
                if event in [1]:
                    ...
                    #print 'PCName. The effect: Powerups'
                    self._bots = bs.BotSet()
                    bs.gameTimer(1000,bs.Call(self._bots.spawnBot,bs.BomberBotProStatic,pos=self.node.position,spawnTime=3000))                    
                elif event == 3:
                    #print 'PCName. The effect: Powerups'                	
                    self._bots = bs.BotSet()
                    bs.gameTimer(1000,bs.Call(self._bots.spawnBot,bs.NinjaBot,pos=self.node.position,spawnTime=3000))                   
                elif event == 4:
                    #print 'PCName. The effect: Powerups'                	
                    self._bots = bs.BotSet()
                    bs.gameTimer(1000,bs.Call(self._bots.spawnBot,bs.BunnyBot,pos=self.node.position,spawnTime=3000))                   
                elif event == 5:
                    #print 'PCName. The effect: Powerups'                	
                    self._bots = bs.BotSet()
                    bs.gameTimer(1000,bs.Call(self._bots.spawnBot,bs.MelBot,pos=self.node.position,spawnTime=3000))    
        bs.gameTimer(15000,bs.Call(_bot),repeat=True)
