...
def __init__(self, vrOverlayCenterOffset=None):
        ...
        def text():
                ...
                t = bs.newNode('text',
                       attrs={ 'text':u'Join our discord family through - https://dsc.gg/jeet',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':'Click on STATS and join DISCORD',
                              'scale':1.3,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'Join discord and get free tags',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'Send your complains or suggestions in discord',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,139),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':'Welcome to server by Jeet',
                               'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
        ...
        if not bs.getEnvironment().get('toolbarTest',True):
            self.modpack = bs.NodeActor(bs.newNode('text',
                                                  attrs={'vAttach':'bottom',
                                                         ...
                                                         'scale':0.85,
                                                         'position':(0,5),
                                                         'text':u'Owned by Jeet'}))    #adjust per name
